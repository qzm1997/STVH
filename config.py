...
class Config(object):
    ...
    def __init__(self, dataset_name):
        ...
        if dataset_name=='volleyball':
            self.data_path = '/mnt/dataset/VolleyBall/data/videos' #data path for the volleyball dataset
            ...
            self.data_path='/mnt/dataset/ActivityDataset/'  #data path for the collective dataset
        ...
        self.actions_loss_weight = 0.5  #weight used to balance action loss and activity loss
        ...
        self.model_path=''  #path of the base model, need to be set in stage2
        self.test_before_train=False
        self.exp_note='Group-Activity-Hash'
        self.exp_name=None
        self.set_bn_eval = False
        self.inference_module_name = 'STVH_volleyball'
